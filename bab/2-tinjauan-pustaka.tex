...
Dengan mendapatkan data jarak sebenarnya dari data kamera, maka data tersebut bisa digunakan untuk menghitung posisi bola pada lapangan. Hal itu dilakukan dengan cara menghitung koordinat polar dari data kamera lalu mengubah koordinat polar tersebut menjadi koordinat kartesian. Atau bisa dirumuskan sebagai berikut: 
\begin{algorithm}
...
\begin{figure}[H]
    ...
    \caption{Konsep Kamera Omnivsion.}
