...
\begin{enumerate}[nolistsep]
  ...
  \item Mempercepat proses pengambilan data. Hal ini bisa dilakukan dengan cara mengambil data secara otomatis yaitu menggantikan peran manusia yang meng-klik gambar kamera lalu memasangkan marker satu persatu menjadi sistem otomatis dengan cara mendeteksi warna marker yang ada. 
